sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "בטל";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "השתמש במקש Shift יחד עם מקשי החצים כדי לשנות את הגודל";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "השתמש במקשי החצים כדי לזוז";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "השתמש במקשי החצים כדי לזוז, ובמקש Shift יחד עם מקשי החצים כדי לשנות גודל";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "עבור באמצעות Tab לסוף הדיאלוג כדי להגיע לידית ''גרור ושנה גודל''";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "עבור באמצעות Tab לסוף הדיאלוג כדי להגיע לידית ''גרור''.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "עבור באמצעות Tab לסוף הדיאלוג כדי להגיע לידית ''שנה גודל''";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "גרור ידית כדי לשנות גודל (shift+חץ)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "דיאלוג ''גרור ושנה גודל''";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "דיאלוג ''גרור''";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "דיאלוג ''שנה גודל''";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "ידית";
	var DIALOG_HEADER_ARIA_LABEL = "כותרת";
	var DIALOG_CONTENT_ARIA_LABEL = "תוכן";
	var DIALOG_FOOTER_ARIA_LABEL = "כותרת תחתונה";
	var LABEL_COLON = ":";
