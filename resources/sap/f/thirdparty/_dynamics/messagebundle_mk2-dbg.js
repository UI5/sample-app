sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Откажи";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Користете ги копчињата Shift + копчињата со стрелки за промена на големината";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Користете ги копчињата со стрелки за движење";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Користете ги копчињата  Shift + копчињата со стрелки за промена на големината";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Прескокнете на крајот на дијалогот за да дојдете до рачката за повлекување и промена на големина.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Прескокнете на крајот на дијалогот за да дојдете до рачката за повлекување.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Прескокнете на крајот на дијалогот за да дојдете до рачката за промена на големина.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Повлечи ја рачката за промена на големина (shift+arrow)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Повлечи и промени ја големината на дијалогот";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Повлечи го дијалогот";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Промени ја големината на дијалогот";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Рачка";
	var DIALOG_HEADER_ARIA_LABEL = "Заглавие";
	var DIALOG_CONTENT_ARIA_LABEL = "Содржина";
	var DIALOG_FOOTER_ARIA_LABEL = "Подножје";
	var LABEL_COLON = ":";
