sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "İptal et";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Yeniden boyutlandırmak için shift+ok tuşlarını kullanın";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Taşımak için ok tuşlarını kullanın";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Taşımak için ok tuşlarını, yeniden boyutlandırmak için Shift+ok tuşlarını kullanın";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Sürükleme ve yeniden boyutlandırma tutamacına ulaşmak için iletişim kutusunun sonuna kaydırın.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Sürükleme tutamacına ulaşmak için iletişim kutusunun sonuna kaydırın.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Yeniden boyutlandırma tutamacına ulaşmak için iletişim kutusunun sonuna kaydırın.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Yeniden boyutlandırmak için tutamacı kaydırın (shift+ok)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "İletişim kutusunu sürükleyin ve yeniden boyutlandır";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "İletişim kutusunu sürükle";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "İletişim kutusunu yeniden boyutlandır";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Tutamaç";
	var DIALOG_HEADER_ARIA_LABEL = "Başlık";
	var DIALOG_CONTENT_ARIA_LABEL = "İçerik";
	var DIALOG_FOOTER_ARIA_LABEL = "Altbilgi";
	var LABEL_COLON = ":";
