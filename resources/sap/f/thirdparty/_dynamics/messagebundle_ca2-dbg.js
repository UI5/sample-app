sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Cancel·lar";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Utilitzeu les tecles majús+fletxa per ajustar la mida";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Utilitzeu les tecles de fletxa per desplaçar-vos";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Utilitzeu les tecles de fletxa per desplaçar-vos, Majús+fletxa per ajustar la mida";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Premeu la tabulació fins el final del diàleg per arribar al control d''arrossegar i ajustar la mida.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Premeu la tabulació fins el final del diàleg per arribar al control d''arrossegar.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Premeu la tabulació fins el final del diàleg per arribar al control d''ajustar la mida.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Control d''arrossegar per ajustar la mida (majús+fletxa)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Diàleg per arrossegar i ajustar la mida";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Diàleg per arrossegar";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Diàleg per ajustar la mida";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Control";
	var DIALOG_HEADER_ARIA_LABEL = "Capçalera";
	var DIALOG_CONTENT_ARIA_LABEL = "Contingut";
	var DIALOG_FOOTER_ARIA_LABEL = "Peu de pàgina";
	var LABEL_COLON = ":";
