sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "रद्द करें";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "आकार के लिए शिफ्ट+तीर कुंजियों का उपयोग करें";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "स्थानांतरण के लिए तीर कुंजियों का उपयोग करें";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "स्थानांतरण के लिए तीर कुंजियों का, आकार बदलने के लिए शिफ्ट+तीर कुंजियां उपयोग करें";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "ड्रैग और रिसाइज़ हैंडल तक पहुंचने के लिए डायलॉग के अंत तक टैब करें.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "ड्रैग हैंडल तक पहुंचने के लिए डायलॉग के अंत तक टैब करें.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "रिसाइज़ हैंडल तक पहुंचने के लिए डायलॉग के अंत तक टैब करें.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "रिसाइज़ (शिफ़्ट+तीर) के लिए ड्रैग हैंडल";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "ड्रैग और रिसाइज़ डायलॉग";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "ड्रैग डायलॉग";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "रिसाइज़ डायलॉग";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "हैंडल";
	var DIALOG_HEADER_ARIA_LABEL = "शीर्षलेख";
	var DIALOG_CONTENT_ARIA_LABEL = "सामग्री";
	var DIALOG_FOOTER_ARIA_LABEL = "पादलेख";
	var LABEL_COLON = ":";
