sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Ακύρωση";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Πατήστε τα πλήκτρα Shift+Arrow για αλλαγή μεγέθους";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Πατήστε τα πλήκτρα βέλους για μετακίνηση";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Πατήστε τα πλήκτρα βέλους για μετακίνηση, τα πλήκτρα Shift+Arrow για αλλαγή μεγέθους";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Πατήστε στο τέλος του διαλόγου για να φθάσετε στον μοχλό μεταφοράς και αλλαγής μεγέθους";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Πατήστε στο τέλος του διαλόγου για να φθάσετε στον μοχλό μεταφοράς.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Πατήστε στο τέλος του διαλόγου για να φθάσετε στον μοχλό αλλαγής μεγέθους.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Μοχλός μεταφοράς για αλλαγή μεγέθους  (shift+βέλος)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Διάλογος Μεταφοράς και Αλλαγής Μεγέθους";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Διάλογος Μεταφοράς";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Διάλογος Αλλαγής Μεγέθους";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Μοχλός";
	var DIALOG_HEADER_ARIA_LABEL = "Κεφαλίδα";
	var DIALOG_CONTENT_ARIA_LABEL = "Περιεχόμενο";
	var DIALOG_FOOTER_ARIA_LABEL = "Υποσέλιδο";
	var LABEL_COLON = ":";
