sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Zrušiť";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Pre zmenu veľkosti stlačte tlačidlo Shift + príslušné kurzorové klávesy";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Na presunutie použite kurzorové klávesy";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Na presunutie použite kurzorové klávesy a pre zmenu veľkosti stlačte tlačidlo Shift + príslušné kurzorové klávesy";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Pre dosiahnutie popisovača presunutia a zmeny veľkosti prejdite na koniec dialógového okna pomocou tabulátora.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Pre dosiahnutie popisovača presunutia a prejdite na koniec dialógového okna pomocou tabulátora.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Pre dosiahnutie popisovača zmeny veľkosti prejdite na koniec dialógového okna pomocou tabulátora.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Potiahnutím popisovača zmeňte veľkosť (shift+šípka)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Dialógové okno Presunutie a zmena veľkosti";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Dialógové okno presunutia";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Dialógové okno zmeny veľkosti";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Popisovač";
	var DIALOG_HEADER_ARIA_LABEL = "Hlavička";
	var DIALOG_CONTENT_ARIA_LABEL = "Obsah";
	var DIALOG_FOOTER_ARIA_LABEL = "Pätička";
	var LABEL_COLON = ":";
