sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "キャンセル";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Shift + 矢印キーを使用してサイズを変更します";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "矢印キーを使用して移動します";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "矢印キーを使用して移動し、Shift + 矢印キーを使用してサイズを変更します";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Tab を使用してダイアログの最後に移動し、ハンドルのリーチドラッグとサイズ変更を行います";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Tab を使用してダイアログの最後に移動し、ハンドルのリーチドラッグを行います";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Tab を使用してダイアログの最後に移動し、ハンドルのリーチサイズ変更を行います";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "ハンドルをドラッグしてサイズを変更 (Shift + 矢印)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "ダイアログのドラッグとサイズ変更";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "ダイアログのドラッグ";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "ダイアログのサイズ変更";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "ハンドル";
	var DIALOG_HEADER_ARIA_LABEL = "ヘッダ";
	var DIALOG_CONTENT_ARIA_LABEL = "コンテンツ";
	var DIALOG_FOOTER_ARIA_LABEL = "フッタ";
	var LABEL_COLON = ":";
