sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Болдырмау";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Өлшемін өзгерту үшін Shift + көрсеткі пернелерін пайдаланыңыз";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Жылжыту үшін көрсеткі пернелерін пайдаланыңыз";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Жылжыту үшін көрсеткі пернелерін, өлшемін өзгерту үшін Shift + көрсеткі пернелерін пайдаланыңыз";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Сүйреу және өлшемін өзгерту тұтқасына жету үшін диалогтік терезенің соңына түсіңіз.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Сүйреу тұтқасына жету үшін диалогтік терезенің соңына түсіңіз.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Өлшемін өзгерту тұтқасына жету үшін диалогтік терезенің соңына түсіңіз.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Өлшемін өзгерту үшін тұтқаны сүйреу (Shift + көрсеткі пернелері)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Диалогтік терезені сүйреу және өлшемін өзгерту";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Диалогтік терезені сүйреу";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Диалогтік терезе өлшемін өзгерту";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Тұтқа";
	var DIALOG_HEADER_ARIA_LABEL = "Жоғарғы колонтитул";
	var DIALOG_CONTENT_ARIA_LABEL = "Мазмұн";
	var DIALOG_FOOTER_ARIA_LABEL = "Төменгі колонтитул";
	var LABEL_COLON = ":";
