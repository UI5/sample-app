sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Отменить";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Для изменения размера используйте Shift + клавиши со стрелками";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Для перемещения используйте клавиши со стрелками";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Для перемещения используйте клавиши со стрелками, для изменения размера используйте Shift + клавиши со стрелками";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Нажимайте Tab до конца диалога, чтобы перейти к ползунку перетаскивания и изменения размера.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Нажимайте Tab до конца диалога, чтобы перейти к ползунку перетаскивания.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Нажимайте Tab до конца диалога, чтобы перейти к ползунку изменения размера.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Передвиньте ползунок, чтобы изменить размер (Shift+стрелка)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Диалог перетаскивания и изменения размера";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Диалог перетаскивания";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Диалог изменения размера";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Ползунок";
	var DIALOG_HEADER_ARIA_LABEL = "Заголовок";
	var DIALOG_CONTENT_ARIA_LABEL = "Контент";
	var DIALOG_FOOTER_ARIA_LABEL = "Нижний колонтитул";
	var LABEL_COLON = ":";
