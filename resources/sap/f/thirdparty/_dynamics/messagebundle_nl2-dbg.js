sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Annuleren";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Gebruik de toetsen Shift+cursor om de grootte te wijzigen";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Gebruik de cursortoetsen om te verplaatsen";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Gebruik de cursortoetsen om te verplaatsen en toetsen Shift+cursor om de grootte te wijzigen";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Gebruik de Tabtoets om door te gaan naar het einde van de dialoog om naar de handle voor grootte wijzigen te gaan.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Gebruik de Tabtoets om door te gaan naar het einde van de dialoog om naar de handle voor slepen te gaan.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Gebruik de Tabtoets om door te gaan naar het einde van de dialoog om naar de handle voor grootte wijzigen te gaan.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Sleep de handle om grootte te wijzigen (Shift+cursor)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Dialoog voor slepen en grootte wijzigen";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Dialoog voor slepen";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Dialoog voor grootte wijzigen";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Handle";
	var DIALOG_HEADER_ARIA_LABEL = "Kop";
	var DIALOG_CONTENT_ARIA_LABEL = "Content";
	var DIALOG_FOOTER_ARIA_LABEL = "Voetregel";
	var LABEL_COLON = ":";
