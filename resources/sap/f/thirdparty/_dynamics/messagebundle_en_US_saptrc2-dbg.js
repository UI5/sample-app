sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "NrkQ0UlM6U3UZkQd9VqQHQ_Cancel";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "XCuIazxfMAbCT7OdQE/JJQ_Use shift+arrow keys to resize";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "LZWFYsvj5xo4jjGwyIQl4A_Use arrow keys to move";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "sWUkbp7EboMtywJghO+IWw_Use arrow keys to move, Shift+arrow keys to resize";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "pmvCHnoRFJAcjr24qvpj3g_Tab to the end of dialog to reach drag and resize handle.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "RUc4HehsYQnXvBqUoCL3fg_Tab to the end of dialog to reach drag handle.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "AcQenyBvFJ30r6qhZkdDlg_Tab to the end of dialog to reach resize handle.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "si//mDYgZWiQX7s6Cb3yHA_Drag handle to resize (shift+arrow)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Sx/gL5gzX0XhruoSW2zC3w_Drag and Resize Dialog";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "pL3qPqcRCXAXdzrYGvi73A_Drag Dialog";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "PCcW/R9cjlZCBlTA7SYDLA_Resize Dialog";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "USttFW0WH6sffmf5tSod/w_Handle";
	var DIALOG_HEADER_ARIA_LABEL = "EEFphXIdFtupAElMIHgCpg_Header";
	var DIALOG_CONTENT_ARIA_LABEL = "hWFsUx6Ak80aChBT9IjOMg_Content";
	var DIALOG_FOOTER_ARIA_LABEL = "yqYMxF0CXE03L0PNiyQC6g_Footer";
