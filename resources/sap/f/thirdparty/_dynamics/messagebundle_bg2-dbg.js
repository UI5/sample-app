sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Отказ";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Използвайте Shift+стрелки, за да промените размера";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Придвижвайте се чрез клавишите със стрелки";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Придвижвайте се чрез клавишите със стрелки, а променяйте размера с Shift+стрелки";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Преминете с табулатора до края на диалоговия прозорец, за да достигнете регулатора за провлачване и промяна на размера.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Преминете с табулатора до края на диалоговия прозорец, за да достигнете регулатора за провлачване.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Преминете с табулатора до края на диалоговия прозорец, за да достигнете регулатора за промяна на размера.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Провлачете регулатора, за да промените размера (Shift + стрелка)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Провлачване и промяна на размера на диалоговия прозорец";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Провлачване на диалоговия прозорец";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Промяна на размера на диалоговия прозорец";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Регулатор";
	var DIALOG_HEADER_ARIA_LABEL = "Заглавка";
	var DIALOG_CONTENT_ARIA_LABEL = "Съдържание";
	var DIALOG_FOOTER_ARIA_LABEL = "Долен колонтитул";
	var LABEL_COLON = ":";
