sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "취소";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "크기를 조정하려면 Shift + 화살표 키를 사용";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "이동하려면 화살표 키를 사용";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "이동하려면 화살표 키를 사용하고, 크기를 조정하려면 Shift + 화살표 키를 사용";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "대화 상자의 끝까지 Tab 키를 눌러 이동하면 끌어서 크기 조정 핸들에 도달할 수 있습니다.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "대화 상자의 끝까지 Tab 키를 눌러 이동하면 끌기 핸들에 도달할 수 있습니다.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "대화 상자의 끝까지 Tab 키를 눌러 이동하면 크기 조정 핸들에 도달할 수 있습니다.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "핸들을 끌어서 크기 조정(Shift+화살표 키)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "끌어서 크기 조정 대화 상자";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "끌기 대화 상자";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "크기 조정 대화 상자";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "핸들";
	var DIALOG_HEADER_ARIA_LABEL = "헤더";
	var DIALOG_CONTENT_ARIA_LABEL = "컨텐트";
	var DIALOG_FOOTER_ARIA_LABEL = "푸터";
	var LABEL_COLON = ":";
