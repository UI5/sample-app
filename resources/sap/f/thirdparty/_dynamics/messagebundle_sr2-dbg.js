sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var SELECT_DIALOG_CANCEL_BUTTON = "Одустани";
	...
	var DIALOG_ARIA_DESCRIBEDBY_RESIZABLE = "Користите Shift+стрелице на тастатури за промену величине";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE = "Користите стрелице на тастатури за кретање";
	var DIALOG_ARIA_DESCRIBEDBY_DRAGGABLE_RESIZABLE = "Користите стрелице на тастатури за кретање, Shift+стрелице на тастатури за промену величине";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE_RESIZABLE = "Прескочите на крај дијалога да дођете до регулатора за превлачење и промену величине.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_DRAGGABLE = "Прескочите на крај дијалога да дођете до регулатора за превлачење.";
	var DIALOG_ARIA_DESCRIBEDBY_REACH_RESIZABLE = "Прескочите на крај дијалога да дођете до регулатора за промену величине.";
	var DIALOG_RESIZE_HANDLE_TOOLTIP = "Превуци регулатор за промену величине (shift+стрелица)";
	var DIALOG_DRAG_AND_RESIZE_HANDLE_ARIA_LABEL = "Превуци и промени величину дијалога";
	var DIALOG_DRAG_HANDLE_ARIA_LABEL = "Превуци дијалог";
	var DIALOG_RESIZE_HANDLE_ARIA_LABEL = "Промени величину дијалога";
	var DIALOG_HANDLE_ARIA_ROLEDESCRIPTION = "Регулатор";
	var DIALOG_HEADER_ARIA_LABEL = "Заглавље";
	var DIALOG_CONTENT_ARIA_LABEL = "Садржај";
